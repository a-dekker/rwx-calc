    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Row {
                ...
                width: parent.width
                height: isPortrait ? (rwxpage.height / rwxpage.width > 1.6 ? Theme.itemSizeMedium : Theme.itemSizeSmall) : Theme.paddingLarge * 2.6
